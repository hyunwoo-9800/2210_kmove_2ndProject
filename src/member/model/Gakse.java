...
public class Gakse
{
  ...
  public Gakse(String g_Num, String g_Pw, String g_Namae)
  {
    this.g_Num = g_Num;
    this.g_Pw = g_Pw;
  ...
  public Gakse(String g_Pw, String g_Namae, String g_Mynum, String g_Denwa,
      String g_Mail, String g_Gakunen, String g_Nyugaku, String g_Senko,
      int g_State, int g_Guntai)
  {
  ...
  public Gakse(String g_Num, String g_Pw, String g_Namae, String g_Mynum,
      String g_Denwa, String g_Mail, String g_Gakunen, String g_Senko)
  {
    this.g_Num = g_Num;
    this.g_Pw = g_Pw;
    this.g_Namae = g_Namae;
  ...
  public Gakse(String g_Num, String g_Pw, String g_Namae, String g_Mynum,
      String g_Denwa, String g_Mail, String g_Nyugaku, String g_Gakunen,
      String g_Senko, int g_State, int g_Guntai)
  {
    this.g_Num = g_Num;
    this.g_Pw = g_Pw;
    this.g_Namae = g_Namae;
