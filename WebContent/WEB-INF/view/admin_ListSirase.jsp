          ...
          <table>
            ...
            <c:forEach var="board" items="${ articlePage.content }">
              <tr>
                ...
                <td>${board.bd_Num}</td>
                <td>
                  <a href="siraseRead.do?no=${ board.bd_Num }&pageNo=${ articlePage.currentPage }">
              ...
              <tr>
                <td colspan="5" align="center">
                  <c:if test="${ articlePage.startPage > 5 }">
                    <a href="siraseList.do?pageNo=${ articlePage.startPage - 5 }">[이전]</a>
                  </c:if>
                  <c:forEach var="pNo" begin="${ articlePage.startPage }" end="${ articlePage.endPage }">
                    <a href="siraseList.do?pageNo=${ pNo }">[${pNo}]</a>
                  </c:forEach>
                  <c:if test="${ articlePage.endPage < articlePage.totalPages }">
                    <a href="siraseList.do?pageNo=${ articlepage.startPage + 5 }">[다음]</a>
                  </c:if>
                </td>
              </tr>
            </c:if>
