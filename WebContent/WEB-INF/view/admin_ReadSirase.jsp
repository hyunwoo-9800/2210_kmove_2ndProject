    ...
    <div class="content">
      <div id="Board" class="tabcontent">
        ...
        <div class="container">
          ...
          <br>
          <a href="siraseList.do" class="btn">목록</a>
          <c:if test="${admin.st_Id == boardData.board.bd_Writer.id}">
          <a href="siraseDelete.do?no=${boardData.board.bd_Num}" class="btn">삭제</a>
          <a href="siraseModify.do?no=${boardData.board.bd_Num}" class="btn">수정</a>
          </c:if>
        </div>
      </div>
    </div>
