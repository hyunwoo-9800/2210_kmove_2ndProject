  ...
  <div class="body">
    ...
    <div class="content">
      <div id="newArticle" class="tabcontent">
        ...
        <div class="container">
          <form action="sirase.do" method="post">
            <table>
              <tr hidden="">
                <th><input type="hidden" name="kubetu" value=1></th>
              </tr>
              <tr>
                <th>작성자</th>
                <td>
                  <input type="text" name="writer" value="${admin.st_Namae}" readonly>
                </td>
              </tr>
              <tr>
                <th>제목</th>
            ...
            <input class="btn-w" type="button" value="취소" onclick="location='siraseList.do'">
          </form>
        </div>
      </div>
    </div>
